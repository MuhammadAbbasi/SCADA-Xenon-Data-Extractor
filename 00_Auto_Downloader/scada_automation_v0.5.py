...
DATE_SEARCH_REGION = (781, 557, 182, 145) # (left, top, width, height) -- expanded height to capture bottom calendar row
...
def process_hourly_report(target_date, target_hour):
    ...
    if target_date == datetime.date.today():
        ...
        # Lowered confidence to 0.65 based on debug results (Edge score ~0.77)
...
def run_bulk_automation(target_date, start_hour=6, end_hour=19):
    """
    Run full automation loop for hours in range(start_hour, end_hour).
    Default: 06:00 to 18:00 (end_hour is exclusive).
    """
...
if __name__ == "__main__":
    ...
    # Run for 2026-02-12
    # You can customize range here: start_hour=0, end_hour=24 for full day
    #time.sleep(600)
    run_bulk_automation(datetime.date(2026, 4, 27), start_hour=12, end_hour=24)
    run_bulk_automation(datetime.date(2026, 4, 28), start_hour=0, end_hour=19)
